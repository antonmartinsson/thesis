...
var svg = d3.select("#likertContainer").append("svg")
  ...
  function createLikert() {
    ...
    if (implementation == "panel") {
      d3.csv("panel_likert.csv", function(error, data) {
        ...
        data.forEach(function(d) {
          ...
          var idx = 0;
          d.boxes = likertColors.domain().map(function(name) { return {name: name, x0: x0, x1: x0 += +d[name], N: +d.N, n: +d[idx += 1]}; });
        });
        ...
        bars.append("rect")
            ...
            .style("fill", function(d) { return likertColors(d.name); });
        ...
        var legend = startp.selectAll(".legend")
            .data(likertColors.domain().slice())
          .enter().append("g")
            .attr("class", "legend")
    ...
    else if (implementation == "popup") {
      d3.csv("popup_likert.csv", function(error, data) {
        console.log(data);
    ...
    else if (implementation == "enlarge") {
      d3.csv("enlarge_likert.csv", function(error, data) {
        console.log(data);
