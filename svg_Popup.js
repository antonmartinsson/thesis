...
function changePopup(data) {
    ...
    /* ------- PIE SLICES -------*/
    var slice = popupSVG.select(".slices").selectAll("path.slice")
        .data(pie(data), key);
    ...
    var text = popupSVG.select(".labels").selectAll("text")
        .data(pie(data), key);
    ...
    var polyline = popupSVG.select(".lines").selectAll("polyline")
        .data(pie(data), key);
